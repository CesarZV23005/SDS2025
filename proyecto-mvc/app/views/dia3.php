    ...
    <main class="container mx-auto px-4 py-12">
        <div class="max-w-6xl mx-auto space-y-12">
            ...
            <section class="text-center space-y-4">
                ...
                <p class="text-muted text-lg">Actividades y eventos del día 3</p>
            </section>
            ...
            <section class="bg-card border border-border rounded-lg p-8 space-y-6">
                ...
                <p class="text-muted">
                    Las actividades previstas para este debia tuvieron que ser canceladas temporalmente debido a la
                    suspensión de clases a nivel nacional por las lluvias.
                </p>
            </section>
                    ...
                    <div>
                        ...
                        <div class="flex justify-center items-center">
                            <div
                                ...
                                <img src="../resources/sds25_5.jpg" alt="Foto 1"
